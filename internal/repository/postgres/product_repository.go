...
// func (r *productRepository) Create(ctx context.Context, product *domain.Product) error {
// 	query := `
// 		INSERT INTO products (name, description, price, stock_quantity, sub_category_id, created_at, updated_at)
...
// 		 sub_category_id = $5, updated_at = $6
// 		WHERE id = $7 AND deleted_at IS NULL
// 	`

// 	result, err := r.db.ExecContext(ctx, query,
// 		product.Name, product.Description, product.Price, product.StockQuantity,
// 		product.SubCategoryID, time.Now(), product.ID)
// 	if err != nil {
