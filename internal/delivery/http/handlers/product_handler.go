...
func (h *ProductHandler) CreateProduct(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		case utils.ErrInvalidCategory:
			api.SendResponse(w, http.StatusBadRequest, "Failed to create product", nil, "The category associated with the sub-category is invalid")
		default:
			api.SendResponse(w, http.StatusInternalServerError, "Failed to create product", nil, "Internal server error")
		}
		return
	}
